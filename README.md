```
coinleft@coinleft.tech ~ $ whoami
> Coinleft... an Indie Hacker who loves to build open-source projects.
> // vibe coding since before the AI era.
```

```
coinleft@coinleft.tech ~ $ cat links.txt
```
